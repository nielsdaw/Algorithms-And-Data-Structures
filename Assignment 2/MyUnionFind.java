...
public class MyUnionFind{
    ...
    private int maxComponentSize;   // the biggest component
    ...
    public void union(int p, int q) {
        ...
        if (size[rootP] < size[rootQ]) {
            ...
            if(size[rootQ] > maxComponentSize) maxComponentSize = size[rootQ];  // increment the maxComponent size if a new is bigger than the previous
        }
        else {
            parent[rootQ] = rootP;
            size[rootP] += size[rootQ];
            if(size[rootP] > maxComponentSize) maxComponentSize = size[rootP];  // increment the maxComponent size if a new is bigger than the previous
        }
        count--;
    }
